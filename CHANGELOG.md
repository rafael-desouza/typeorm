...
-   Suporte a arquivos XML (`xml2js`) removido, eliminando vulnerabilidade de prototype pollution.
-   Dependência do pacote `xml2js` completamente retirada do projeto.
-   Donwgrade da versão do typescript

### Corrigido

-   Ajustes para builds com `better-sqlite3` em ambientes com Node 20+
